//! provenance - LATER MODULE, EXCLUDED FROM THE MVP BUILD.
//!
...
//! ID `module::PROVENANCE` (0x0D); its wire IDs stay reserved and
...
impl ChanceryModule for Module {
    const MODULE_ID: u8 = crate::constants::module::PROVENANCE;

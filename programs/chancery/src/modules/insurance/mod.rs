//! insurance - LATER MODULE, EXCLUDED FROM THE MVP BUILD.
//!
...
//! ID `module::INSURANCE` (0x0E); its wire IDs stay reserved and
...
impl ChanceryModule for Module {
    const MODULE_ID: u8 = crate::constants::module::INSURANCE;

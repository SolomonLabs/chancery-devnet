...
// Category:      event
// File:          SettlementIntentCancelledLog.ts
//
 ...
 */
export class SettlementIntentCancelledLog implements IsLogDecodable {
    static readonly discriminator = new Uint8Array([83, 174, 138, 228, 168, 175, 101, 158]);
    readonly discriminator = SettlementIntentCancelledLog.discriminator;
    ...
    policyId!: U8[];
    intentHash!: U8[];
    cancelledBy!: PublicKeyLike;
    rentRefundRecipient!: PublicKeyLike;

    constructor(props: DecodableProps<SettlementIntentCancelledLog>) {
        Object.assign(this, props);
    }

    static decode(data: string | Base64 | Uint8Array | Buffer | null): SettlementIntentCancelledLog {
        return Decoder.decode(data, SettlementIntentCancelledLog);
    }

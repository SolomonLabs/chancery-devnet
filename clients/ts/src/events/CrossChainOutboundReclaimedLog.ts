...
// Category:      event
// File:          CrossChainOutboundReclaimedLog.ts
//
 ...
 */
export class CrossChainOutboundReclaimedLog implements IsLogDecodable {
    static readonly discriminator = new Uint8Array([200, 29, 165, 139, 104, 166, 193, 50]);
    readonly discriminator = CrossChainOutboundReclaimedLog.discriminator;
    ...
    signerSetId!: U8[];
    pathwayId!: U8[];
    reclaimRecord!: PublicKeyLike;
    senderTokenAccount!: PublicKeyLike;
    attestationCount!: U8;

    constructor(props: DecodableProps<CrossChainOutboundReclaimedLog>) {
        Object.assign(this, props);
    }

    static decode(data: string | Base64 | Uint8Array | Buffer | null): CrossChainOutboundReclaimedLog {
        return Decoder.decode(data, CrossChainOutboundReclaimedLog);
    }

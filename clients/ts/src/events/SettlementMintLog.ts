 ...
 */
export class SettlementMintLog implements IsLogDecodable {
    static readonly discriminator = new Uint8Array([247, 174, 181, 10, 246, 247, 137, 45]);
    readonly discriminator = SettlementMintLog.discriminator;
    ...
    statusFlags!: BU64;
    reasonCode!: U32;
    actualAssetAmountIn!: BU64;

    constructor(props: DecodableProps<SettlementMintLog>) {
        Object.assign(this, props);
    }

    static decode(data: string | Base64 | Uint8Array | Buffer | null): SettlementMintLog {
        return Decoder.decode(data, SettlementMintLog);
    }

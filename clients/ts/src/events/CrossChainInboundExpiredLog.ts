...
// Category:      event
// File:          CrossChainInboundExpiredLog.ts
//
 ...
 */
export class CrossChainInboundExpiredLog implements IsLogDecodable {
    static readonly discriminator = new Uint8Array([83, 81, 102, 71, 45, 76, 59, 172]);
    readonly discriminator = CrossChainInboundExpiredLog.discriminator;
    ...
    constructor(props: DecodableProps<CrossChainInboundExpiredLog>) {
        Object.assign(this, props);
    }

    static decode(data: string | Base64 | Uint8Array | Buffer | null): CrossChainInboundExpiredLog {
        return Decoder.decode(data, CrossChainInboundExpiredLog);
    }

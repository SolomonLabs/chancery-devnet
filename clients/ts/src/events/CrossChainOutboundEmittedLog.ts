...
// Category:      event
// File:          CrossChainOutboundEmittedLog.ts
//
 ...
 */
export class CrossChainOutboundEmittedLog implements IsLogDecodable {
    static readonly discriminator = new Uint8Array([243, 219, 108, 45, 191, 172, 254, 82]);
    readonly discriminator = CrossChainOutboundEmittedLog.discriminator;
    ...
    signerSetId!: U8[];
    pathwayId!: U8[];
    burnedBy!: PublicKeyLike;
    grossAmount!: BU128;
    feeOutputAmount!: BU128;
    rebateAmount!: BU128;
    feePolicyId!: U8[];

    constructor(props: DecodableProps<CrossChainOutboundEmittedLog>) {
        Object.assign(this, props);
    }

    static decode(data: string | Base64 | Uint8Array | Buffer | null): CrossChainOutboundEmittedLog {
        return Decoder.decode(data, CrossChainOutboundEmittedLog);
    }

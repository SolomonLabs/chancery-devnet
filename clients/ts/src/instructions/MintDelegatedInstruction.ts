...
// File:          MintDelegatedInstruction.ts
//
...
/**
 * Source: https://github.com/SolomonLabs/chancery/blob/main/programs/chancery/src/modules/settlement/instructions/mint_delegated.rs
 */
export class MintDelegatedInstruction implements IsEncodable {
    ...
    static readonly discriminator = new Uint8Array([MODULE.SETTLEMENT, IX.settlement.MINT_DELEGATED]);
    ...
    constructor(props: EncodableProps<MintDelegatedInstruction>) {
        Object.assign(this, props);
    }

    encode(): Uint8Array {
        return Encoder.encode(this, MintDelegatedInstruction);
    }

    static decode(data: EncodedInstruction | IsEncodable): MintDelegatedInstruction {
        return Decoder.decode(data, MintDelegatedInstruction);
    }

    accounts(): InstructionAccount[] {
        return Encoder.accounts(this, MintDelegatedInstruction);
    }

    instruction(): EncodedInstruction {
        return Encoder.instruction(this.programId, this, MintDelegatedInstruction);
    }
    ...
    static getAccountsSchema(): EncodeAccountsSchemaOrNull {
        return {
            moduleActivationState: { signer: false, writable: false, pda: MintDelegatedInstruction.programDerivedAccounts.moduleActivationState, accountSize: ACCOUNT_SIZES.MODULE_ACTIVATION_STATE },
            chanceryConfig: { signer: false, writable: true, relations: MintDelegatedInstruction.accountRelations.chanceryConfig.relations },
            eventAuthority: { signer: false, writable: false },
            pauseState: { signer: false, writable: false },
            assetConfig: { signer: false, writable: false, relations: MintDelegatedInstruction.accountRelations.assetConfig.relations },
            pathwayPolicy: { signer: false, writable: false, relations: MintDelegatedInstruction.accountRelations.pathwayPolicy.relations },
            intent: { signer: false, writable: true, relations: MintDelegatedInstruction.accountRelations.intent.relations },
            ...
            assetPauseState: { signer: false, writable: false, relations: MintDelegatedInstruction.accountRelations.assetPauseState.relations },

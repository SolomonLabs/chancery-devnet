...
// File:          RelaxRemoteDomainPauseInstruction.ts
//
...
/**
 * Source: https://github.com/SolomonLabs/chancery/blob/main/programs/chancery/src/modules/cross_chain/instructions/relax_remote_domain_pause.rs
 */
export class RelaxRemoteDomainPauseInstruction implements IsEncodable {
    ...
    static readonly discriminator = new Uint8Array([MODULE.CROSS_CHAIN, IX.cross_chain.RELAX_REMOTE_DOMAIN_PAUSE]);
    ...
    constructor(props: EncodableProps<RelaxRemoteDomainPauseInstruction>) {
        Object.assign(this, props);
    }

    encode(): Uint8Array {
        return Encoder.encode(this, RelaxRemoteDomainPauseInstruction);
    }

    static decode(data: EncodedInstruction | IsEncodable): RelaxRemoteDomainPauseInstruction {
        return Decoder.decode(data, RelaxRemoteDomainPauseInstruction);
    }

    accounts(): InstructionAccount[] {
        return Encoder.accounts(this, RelaxRemoteDomainPauseInstruction);
    }

    instruction(): EncodedInstruction {
        return Encoder.instruction(this.programId, this, RelaxRemoteDomainPauseInstruction);
    }
    ...
    static getAccountsSchema(): EncodeAccountsSchemaOrNull {
        return {
            moduleActivationState: { signer: false, writable: false, pda: RelaxRemoteDomainPauseInstruction.programDerivedAccounts.moduleActivationState, accountSize: ACCOUNT_SIZES.MODULE_ACTIVATION_STATE },

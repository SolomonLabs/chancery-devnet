...
// File:          RedeemDirectInstruction.ts
//
...
/**
 * Source: https://github.com/SolomonLabs/chancery/blob/main/programs/chancery/src/modules/settlement/instructions/redeem_direct.rs
 */
export class RedeemDirectInstruction implements IsEncodable {
    ...
    static readonly discriminator = new Uint8Array([MODULE.SETTLEMENT, IX.settlement.REDEEM_DIRECT]);
    ...
    constructor(props: EncodableProps<RedeemDirectInstruction>) {
        Object.assign(this, props);
    }

    encode(): Uint8Array {
        return Encoder.encode(this, RedeemDirectInstruction);
    }

    static decode(data: EncodedInstruction | IsEncodable): RedeemDirectInstruction {
        return Decoder.decode(data, RedeemDirectInstruction);
    }

    accounts(): InstructionAccount[] {
        return Encoder.accounts(this, RedeemDirectInstruction);
    }

    instruction(): EncodedInstruction {
        return Encoder.instruction(this.programId, this, RedeemDirectInstruction);
    }
    ...
    static getAccountsSchema(): EncodeAccountsSchemaOrNull {
        return {
            moduleActivationState: { signer: false, writable: false, pda: RedeemDirectInstruction.programDerivedAccounts.moduleActivationState, accountSize: ACCOUNT_SIZES.MODULE_ACTIVATION_STATE },
            chanceryConfig: { signer: false, writable: true, relations: RedeemDirectInstruction.accountRelations.chanceryConfig.relations },
            eventAuthority: { signer: false, writable: false },
            pauseState: { signer: false, writable: false },
            assetConfig: { signer: false, writable: false, relations: RedeemDirectInstruction.accountRelations.assetConfig.relations },
            pathwayPolicy: { signer: false, writable: false, relations: RedeemDirectInstruction.accountRelations.pathwayPolicy.relations },
            ...
            assetPauseState: { signer: false, writable: false, relations: RedeemDirectInstruction.accountRelations.assetPauseState.relations },

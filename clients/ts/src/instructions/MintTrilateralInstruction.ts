...
// File:          MintTrilateralInstruction.ts
//
...
/**
 * Source: https://github.com/SolomonLabs/chancery/blob/main/programs/chancery/src/modules/settlement/instructions/mint_trilateral.rs
 */
export class MintTrilateralInstruction implements IsEncodable {
    ...
    static readonly discriminator = new Uint8Array([MODULE.SETTLEMENT, IX.settlement.MINT_TRILATERAL]);
    ...
    constructor(props: EncodableProps<MintTrilateralInstruction>) {
        Object.assign(this, props);
    }

    encode(): Uint8Array {
        return Encoder.encode(this, MintTrilateralInstruction);
    }

    static decode(data: EncodedInstruction | IsEncodable): MintTrilateralInstruction {
        return Decoder.decode(data, MintTrilateralInstruction);
    }

    accounts(): InstructionAccount[] {
        return Encoder.accounts(this, MintTrilateralInstruction);
    }

    instruction(): EncodedInstruction {
        return Encoder.instruction(this.programId, this, MintTrilateralInstruction);
    }
    ...
    static getAccountsSchema(): EncodeAccountsSchemaOrNull {
        return {
            moduleActivationState: { signer: false, writable: false, pda: MintTrilateralInstruction.programDerivedAccounts.moduleActivationState, accountSize: ACCOUNT_SIZES.MODULE_ACTIVATION_STATE },
            chanceryConfig: { signer: false, writable: true, relations: MintTrilateralInstruction.accountRelations.chanceryConfig.relations },
            eventAuthority: { signer: false, writable: false },
            pauseState: { signer: false, writable: false },
            assetConfig: { signer: false, writable: false, relations: MintTrilateralInstruction.accountRelations.assetConfig.relations },
            pathwayPolicy: { signer: false, writable: false, relations: MintTrilateralInstruction.accountRelations.pathwayPolicy.relations },
            intent: { signer: false, writable: true, relations: MintTrilateralInstruction.accountRelations.intent.relations },

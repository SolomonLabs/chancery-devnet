...
// File:          SetExecutorPauseInstruction.ts
//
...
/**
 * Source: https://github.com/SolomonLabs/chancery/blob/main/programs/chancery/src/modules/control/instructions/set_executor_pause.rs
 */
export class SetExecutorPauseInstruction implements IsEncodable {
    static readonly discriminator = new Uint8Array([MODULE.CONTROL, IX.control.SET_EXECUTOR_PAUSE]);
    ...
    constructor(props: EncodableProps<SetExecutorPauseInstruction>) {
        Object.assign(this, props);
    }

    encode(): Uint8Array {
        return Encoder.encode(this, SetExecutorPauseInstruction);
    }

    static decode(data: EncodedInstruction | IsEncodable): SetExecutorPauseInstruction {
        return Decoder.decode(data, SetExecutorPauseInstruction);
    }

    accounts(): InstructionAccount[] {
        return Encoder.accounts(this, SetExecutorPauseInstruction);
    }

    instruction(): EncodedInstruction {
        return Encoder.instruction(this.programId, this, SetExecutorPauseInstruction);
    }

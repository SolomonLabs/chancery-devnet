...
// File:          UpdateLimitPolicyWithPendingChangeInstruction.ts
//
...
/**
 * Source: https://github.com/SolomonLabs/chancery/blob/main/programs/chancery/src/modules/limits/instructions/update_limit_policy_with_pending_change.rs
 */
export class UpdateLimitPolicyWithPendingChangeInstruction implements IsEncodable {
    ...
    static readonly discriminator = new Uint8Array([MODULE.LIMITS, IX.limits.UPDATE_LIMIT_POLICY_WITH_PENDING_CHANGE]);
    ...
    constructor(props: EncodableProps<UpdateLimitPolicyWithPendingChangeInstruction>) {
        Object.assign(this, props);
    }

    encode(): Uint8Array {
        return Encoder.encode(this, UpdateLimitPolicyWithPendingChangeInstruction);
    }

    static decode(data: EncodedInstruction | IsEncodable): UpdateLimitPolicyWithPendingChangeInstruction {
        return Decoder.decode(data, UpdateLimitPolicyWithPendingChangeInstruction);
    }

    accounts(): InstructionAccount[] {
        return Encoder.accounts(this, UpdateLimitPolicyWithPendingChangeInstruction);
    }

    instruction(): EncodedInstruction {
        return Encoder.instruction(this.programId, this, UpdateLimitPolicyWithPendingChangeInstruction);
    }
    ...
    static getAccountsSchema(): EncodeAccountsSchemaOrNull {
        return {
            moduleActivationState: { signer: false, writable: false, pda: UpdateLimitPolicyWithPendingChangeInstruction.programDerivedAccounts.moduleActivationState, accountSize: ACCOUNT_SIZES.MODULE_ACTIVATION_STATE },
            chanceryConfig: { signer: false, writable: true, relations: UpdateLimitPolicyWithPendingChangeInstruction.accountRelations.chanceryConfig.relations },
